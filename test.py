...
class CertificateHandler(BaseHandler):
    ...
    def process_certificate_choice1(self, message):
    ...
    def process_certificate_choice(self, message):
        ...
        # Сохраняем название справки, выбранной пользователем
    ...
    def final_confirmation(self, message):
        ...
        if message.text == 'Данные верны':
            ...
            user_info_str = f"Имя: {user_name}, ID: {user_id}, Username: @{username}"
