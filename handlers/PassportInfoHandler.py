...
class PassportInfoHandler(BaseHandler):
    ...
    def show_child_passport_info(self, message):
        ...
        response = ("📝 *Документы, необходимые для замены детского паспорта:*\n\n"
                    ...
                    "👉 *Продление паспорта:*\n"
                    "1️⃣ Паспорт ребенка.\n"
                    "2️⃣ Четыре фотографии, подписанные с обратной стороны.\n"
                    "3️⃣ Копия свидетельства о рождении.\n"
                    "4️⃣ Если ребенок старше 14 лет, необходимо оплатить госпошлину (оплата должна быть осуществлена по месту регистрации).\n\n"
                    ...
                    "💳 *Пути оплаты госпошлины за паспорт (Если ребенку 14-ть и более лет):*\n"
                    "🔹 Ерип - МВД - Гражданство и миграция - для граждан Белоруси - г. Гомель - Выбрать район - Выдача и обмен паспорта.\n\n"
                    "💳 *Пути оплаты госпошлины за ускорения изготовления паспорта:*\n"
                    "🔹 Ерип - МВД - Гражданство и миграция - для граждан Белоруси - г. Гомель - Выбрать район - Доплата за паспорт 7 или 15 дней.\n\n"
                    "💳 *Пути оплаты госпошлины за SMS-оповещение:*\n"
                    "🔹 Ерип - МВД - Гражданство и миграция - для граждан Белоруси - г. Гомель - Выбрать район - Дополнительные услуги.\n\n")
    ...
    def show_adult_passport_info(self, message):
        ...
        response = ("📝 *Документы, необходимые для замены паспорта для взрослых:*\n\n"
                    "1️⃣ Паспорт заявителя.\n"
                    "2️⃣ Четыре фотографии, подписанные с обратной стороны.\n"
                    "3️⃣ Копия свидетельства о рождении заявителя.\n"
                    "4️⃣ Копия свидетельства о рождении детей, если ребенок не достиг 18 лет.\n"
                    "5️⃣ Копия свидетельства о браке или решение суда о разводе.\n"
                    ...
                    "️6️⃣ Квитанция об уплате госпошлины.\n\n"
                    "🔎 *Дополнительная информация:*\n"
                    "🔸 При необходимости ускоренного изготовления документа также требуется предоставить квитанцию об уплате госпошлины за ускорение. Доступны варианты сроков изготовления: 7 и 15 дней.\n"
                    "🔸 Платно доступно SMS-оповещение о готовности паспорта.\n\n"
                    "💳 *Пути оплаты госпошлины за паспорт:*\n"
                    "🔹 Ерип - МВД - Гражданство и миграция - для граждан Белоруси - г. Гомель - Выбрать район - Выдача и обмен паспорта.\n\n"
                    "💳 *Пути оплаты госпошлины за ускорения изготовления паспорта:*\n"
                    "🔹 Ерип - МВД - Гражданство и миграция - для граждан Белоруси - г. Гомель - Выбрать район - Доплата за паспорт 7 или 15 дней.\n\n"
                    "💳 *Пути оплаты госпошлины за SMS-оповещение:*\n"
